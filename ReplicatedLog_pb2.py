...
# source: proto/ReplicatedLog.proto
...
_POST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg', full_name='POST.msg', index=0,
...
POST = _reflection.GeneratedProtocolMessageType('POST', (_message.Message,), {
  'DESCRIPTOR' : _POST,
  '__module__' : 'proto.ReplicatedLog_pb2'
