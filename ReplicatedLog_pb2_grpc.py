...
from proto import ReplicatedLog_pb2 as proto_dot_ReplicatedLog__pb2
...
class PostRequestServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PostRequest = channel.unary_unary(
                ...
                request_serializer=proto_dot_ReplicatedLog__pb2.POST.SerializeToString,
                response_deserializer=proto_dot_ReplicatedLog__pb2.POSTResponse.FromString,
                )
...
def add_PostRequestServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PostRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proto_dot_ReplicatedLog__pb2.POST.FromString,
                    response_serializer=proto_dot_ReplicatedLog__pb2.POSTResponse.SerializeToString,
            ),
    }
...
class PostRequestService(object):
    ...
    def PostRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/PostRequestService/PostRequest',
            proto_dot_ReplicatedLog__pb2.POST.SerializeToString,
            proto_dot_ReplicatedLog__pb2.POSTResponse.FromString,
...
class GetRequestServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRequest = channel.unary_unary(
                ...
                request_serializer=proto_dot_ReplicatedLog__pb2.GET.SerializeToString,
                response_deserializer=proto_dot_ReplicatedLog__pb2.GETResponse.FromString,
                )
...
def add_GetRequestServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetRequest': grpc.unary_unary_rpc_method_handler(
                    servicer.GetRequest,
                    request_deserializer=proto_dot_ReplicatedLog__pb2.GET.FromString,
                    response_serializer=proto_dot_ReplicatedLog__pb2.GETResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class GetRequestService(object):
    ...
    def GetRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/GetRequestService/GetRequest',
            proto_dot_ReplicatedLog__pb2.GET.SerializeToString,
            proto_dot_ReplicatedLog__pb2.GETResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
